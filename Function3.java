...
public class Function3 extends JPanel implements Runnable, MouseListener, MouseMotionListener
{
    ...
    public void mouseMoved(MouseEvent e)
    {
        ...
        double function = 100*Math.sin((0.02*x));
          if (y>0 && y<1000 && x>0 && x<1000) {
          Sound wavefunction = new Sound();
          try {
          Sound.createTone((((function+200))), 100, 10000);
